...
insert_queries = (
    ...
    "INSERT INTO quizzes (quiz_id, test_id, order_num, credit_value, gained_credit, type, text_body, title, instructions) VALUES (1, 1, 1, 0, 0, 'multiple_choice', 'Here there is some text', 'What should be avoided except in emergencies?', 'To complete this quiz please select an answer and then click next');",
    ...
    "INSERT INTO quizzes (quiz_id, test_id, order_num, credit_value, gained_credit, type, text_body, title, instructions) VALUES(2, 1, 2, 0, 0, 'multiple_choice', 'Some text - this is title', 'Choose the most appropriate from the following options that best describes the aim of the Child Protection Policy:', 'To complete this quiz please select an answer and then click next');",
