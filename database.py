...
insert_queries = ( # these are queries used only for inserting test data, this should not be needed once the form to make quizzes is implemented
    ...
    "INSERT INTO topics (topic_id, is_unlocked, name, needed_credit) VALUES (1, 1, 'Child Protection Policy', 100);",
        # Test 1
        ...
        "INSERT INTO tests (test_id, topic_id, is_unlocked, max_credit, order_num, gained_credit, pass_credit, description, is_retakeable, is_official) VALUES (2, 1, 1, 40, 2, 0, 20, 'This test tests you on the aim of the Child Protection Policy. You have only one attempt for this test.', 0, 1);",
            ...
            # Quiz 2
            "INSERT INTO quizzes (quiz_id, test_id, order_num, credit_value, gained_credit, quiz_type, text_body, title, instructions) VALUES (6, 2, 2, 10, 0, 'multiple_choice', 'What children does Slum Soccer ensures safety and protection to?', 'Question 1', 'Select your answer and click on continue...');",
    ...
    "INSERT INTO topics (topic_id, is_unlocked, name, needed_credit) VALUES (2, 1, 'Another Topic', 120);",
        ...
        "INSERT INTO tests (test_id, topic_id, is_unlocked, max_credit, order_num, gained_credit, pass_credit, description, is_retakeable, is_official) VALUES (5, 2, 1, 50, 1, 0, 25, 'This is a practice test teaching you about colours. IT s not official so you can take it as often as you wish.', 1, 0);",
            ...
            # Quiz 2
            "INSERT INTO quizzes (quiz_id, test_id, order_num, credit_value, gained_credit, quiz_type, text_body, title, instructions) VALUES(12, 5, 2, 10, 0, 'multiple_choice', 'What is the opposite colour of blue?', 'Question 1', 'Only one of them answers is correct. Select your answer and when you feel ready click continue.');",
            ...
            # Quiz 4
            "INSERT INTO quizzes (quiz_id, test_id, order_num, credit_value, gained_credit, quiz_type, text_body, title, instructions) VALUES(14, 5, 4, 10, 0, 'multiple_choice', 'What color reflects all colours?', 'Question 3', 'Only one of them answers is correct. Select your answer and when you feel ready click continue.');",
            ...
            # Quiz 7
            "INSERT INTO quizzes (quiz_id, test_id, order_num, credit_value, gained_credit, quiz_type, text_body, title, instructions) VALUES(17, 5, 7, 10, 0, 'multiple_choice', 'Do all animals see the same colours?', 'Question 5', 'Only one of them answers is correct. Select your answer and when you feel ready click continue.');",
    ...
    # Topic 4 - Topic
    "INSERT INTO topics (topic_id, is_unlocked, name, needed_credit) VALUES (4, 0, 'Topic', 60);",
        # Test 1 - locked and empty
    ...
    "INSERT INTO topics (topic_id, is_unlocked, name, needed_credit) VALUES (6, 0, 'Topic of all the topics', 5);",
        # Test 1 - locked and empty
    ...
    "INSERT INTO topics (topic_id, is_unlocked, name, needed_credit) VALUES (7, 0, 'Topic as well', 500);",
        # Test 1 - locked and empty
    ...
    "INSERT INTO topics (topic_id, is_unlocked, name, needed_credit) VALUES (8, 0, 'Incomplete topic', 25);",
        # Test 1 - locked and empty
